    ...
    <div className="col-md-6">
      <div className="card p-4 shadow-lg border-0 rounded-4">
        ...
        <div className="d-flex align-items-center mb-3 contact-item">
          ...
          <a href="https://github.com/KaShiekzmi" className="contact-link">
            GitHub: Pawpals
          </a>
        </div>
        ...
        <div className="d-flex align-items-center mb-3 contact-item">
          ...
          <a href="https://www.instagram.com/kaxhie_x/" className="contact-link">
            Instagram: @PawPals_x
          </a>
        </div>
        ...
        <div className="d-flex align-items-center mb-1 contact-item">
          ...
          <a href="tel:+91 9474329877" className="contact-link">
            +91 9474329877
          </a>
        </div>
