        ...
        <div className='container-fluid'>
            ...
            <div className="collapse navbar-collapse" id="mainNav">
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0 fs-6">
                    ...
                    {/* <li className="nav-item mx-2 fw-bold" >
                        <a className="nav-link" href="/profile" onMouseEnter={(e) => {
                            e.target.classList.add("bg-warning","rounded-pill", "text-white");
                        }}
                            onMouseLeave={(e) => {
                                e.target.classList.remove("bg-warning", "text-white");
                            }}>Profile</a>
                    </li> */}
                    <li className="nav-item mx-2 fw-bold">
                ...
                {/* CTA Button */}
                <button className="btn btn-warning text-white rounded-pill px-4 fw-semibold "
                    onMouseEnter={(e) => {

                        e.target.classList.add("btn-warning","shadow-lg");
                    }}
                    onMouseLeave={(e) => {
